...
function runCase(sequence, window, fromLevel, toLevel, Layer, optimized) {
  ...
  return {
    ...
    directPairsCreated: replacementTopology?.constructionTimings.directPairsCreated ?? 0,
    directPairsReused: replacementTopology?.constructionTimings.directPairsReused ?? 0,
